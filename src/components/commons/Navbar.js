                ...
                <div className="navbar-collapse collapse text-center" id="navbarNav">
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <NavLink exact activeClassName="active" className="nav-link mx-2" to="/"><FontAwesomeIcon icon={faHome}/> Beranda</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink activeClassName="active" className="nav-link mx-2" to="/faq"><FontAwesomeIcon icon={faQuestionCircle}/> FAQ</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink activeClassName="active" className="nav-link mx-2" to="/hotline"><FontAwesomeIcon icon={faPhone}/> Hotline</NavLink>
                        </li>
                    </ul>
